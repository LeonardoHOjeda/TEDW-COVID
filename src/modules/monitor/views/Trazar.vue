<template>
  <div>
    <br>
    <Titulos titulo="Trazar" subtitulo="Aqui podras mandar alertas a las personas con las que alguna persona infectada/contagiada haya tenido contacto" />
    <br>
          ...
          for (let i = 0; i < res.data.length; i++) {
            if(res.data[i].medico) {
              this.items.push({
                ...
                nombre: res.data[i].medico.nombre + " " + res.data[i].medico.a_paterno + " " + res.data[i].medico.a_materno,          
              })
            }
              ...
              this.items.push({
                id: res.data[i].usuario_id,
                email: res.data[i].email,
                nombre: res.data[i].estudiante.nombre + " " + res.data[i].estudiante.a_paterno + " " + res.data[i].estudiante.a_materno,          
              })
            }
              ...
              this.items.push({
                id: res.data[i].usuario_id,
                email: res.data[i].email,
                nombre: res.data[i].personal.nombre + " " + res.data[i].personal.a_paterno + " " + res.data[i].personal.a_materno,          
              })
            }
            this.cargando = false
          }
