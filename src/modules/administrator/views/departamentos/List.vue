<template>
  <div class="mt-4">
    ...
    <div class="d-flex justify-content-between mb-3">
      ...
      <router-link to="/admin/departamentos/add" class="btn btn-sm btn-success">
        ...
        >
          ...
          <template #cell(actions)="row">
            <div>
              ...
              <router-link
                :to="`/admin/departamentos/update/${row.item.departamento_id}`"
                size="sm"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState('admin/departments', ['departments', 'error']),
    },
    methods: {
      ...mapActions('admin/departments', [
        'fetchDepartments',
        'deleteDepartment',
      ]),
