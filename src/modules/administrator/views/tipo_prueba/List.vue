<template>
  <b-container class="mt-4">
    ...
    <div class="d-flex justify-content-between mb-3">
      <h3 class="m-0">Tipos de Prueba</h3>
      <router-link to="/admin/tipo_prueba/add" class="btn btn-sm btn-success">
      ...
      <b-col cols="12">
        ...
        >
          ...
          <template #cell(acciones)="row">
            <div>
              <b-btn size="sm" variant="danger" @click="confirmDelete(row.item.tipo_id)">
                <i class="fas fa-trash"></i>
              </b-btn>
              <router-link
                :to="`/admin/tipo_prueba/update/${row.item.tipo_id}`"
                size="sm"
...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      currentPage: 1,
      fields: [
        { key: 'tipo_id', label: 'ID', sortable: true },
    ...
    computed: {
      ...mapState('admin/tipo_prueba', ['tipos', 'error']),
    },
    methods: {
      ...mapActions('admin/tipo_prueba', ['fetchTipos', 'deleteTipo']),
