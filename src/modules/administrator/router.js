const routes = [
    ...
    },
    {
        ...
        component: () =>
            import ('./views/personal/Add.vue'),
    },
    {
        path: '/admin/personal/update/:id',
        name: '/admin/personal/update/:id',
        component: () =>
            import ('./views/personal/Update.vue'),
    },
    //Medicos
    {
        path: '/admin/medicos',
    ...
    //usuarios
    {
        ...
        component: () =>
            import ('./views/usuarios/Update.vue'),
    },
]
